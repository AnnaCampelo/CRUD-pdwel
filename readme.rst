...
- Autenticação
- Listagem de usuário
- Criação de CEP e endereços
- Busca CEP e endereços
- Listagem de CEP e endereços
- Adição e remoção de cargos por parte do admin
- Aprovação ou reprovação de CEPs e endereços
